...
export class StatisticsApi extends runtime.BaseAPI {
   ...
   */
  async statisticsNumberOfActiveMembersAtDateRetrieveRaw(
    requestParameters: StatisticsNumberOfActiveMembersAtDateRetrieveRequest,
    ...
    if (requestParameters["atDate"] != null) {
      queryParameters["at_date"] = (requestParameters["atDate"] as any)
        .toISOString()
        .substring(0, 10);
    }
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfActiveMembersAtDateRetrieve(
    requestParameters: StatisticsNumberOfActiveMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<number> {
    const response =
      await this.statisticsNumberOfActiveMembersAtDateRetrieveRaw(
        requestParameters,
        initOverrides,
      );
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfFrozenMembersAtDateRetrieveRaw(
    requestParameters: StatisticsNumberOfFrozenMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<number>> {
    if (requestParameters["atDate"] == null) {
      throw new runtime.RequiredError(
    ...
    if (requestParameters["atDate"] != null) {
      console.log(requestParameters["atDate"]);
      queryParameters["at_date"] = (requestParameters["atDate"] as any)
        .toISOString()
        .substring(0, 10);
    }
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfFrozenMembersAtDateRetrieve(
    requestParameters: StatisticsNumberOfFrozenMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<number> {
    const response =
      await this.statisticsNumberOfFrozenMembersAtDateRetrieveRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfMembersAtDateRetrieveRaw(
    requestParameters: StatisticsNumberOfMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<number>> {
    if (requestParameters["atDate"] == null) {
      throw new runtime.RequiredError(
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfMembersAtDateRetrieve(
    requestParameters: StatisticsNumberOfMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<number> {
    const response = await this.statisticsNumberOfMembersAtDateRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfPurchasingMembersAtDateRetrieveRaw(
    requestParameters: StatisticsNumberOfPurchasingMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<number>> {
    if (requestParameters["atDate"] == null) {
      throw new runtime.RequiredError(
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfPurchasingMembersAtDateRetrieve(
    requestParameters: StatisticsNumberOfPurchasingMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<number> {
    const response =
      await this.statisticsNumberOfPurchasingMembersAtDateRetrieveRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfWorkingMembersAtDateRetrieveRaw(
   ...
   * Verify that the current user is authenticated.
   */
  async statisticsNumberOfWorkingMembersAtDateRetrieve(
    requestParameters: StatisticsNumberOfWorkingMembersAtDateRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<number> {
    const response =
      await this.statisticsNumberOfWorkingMembersAtDateRetrieveRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
