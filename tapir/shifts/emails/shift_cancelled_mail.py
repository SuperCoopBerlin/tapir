...
class ShiftCancelledEmailBuilder(TapirEmailBuilderBase):
    ...
    def get_unique_id(cls) -> str:
        return "tapir.shifts.shift_cancelled"

    @classmethod
    def get_name(cls) -> str:
        return _("Shift cancelled")

    @classmethod
    def get_description(cls) -> str:
        return _("Sent to a member when the member office marks the shift as cancelled")

    def get_subject_templates(self) -> list:
        return [
            "shifts/email/shift_cancelled.subject.html",
        ]

    def get_body_templates(self) -> list:
        return [
            "shifts/email/shift_cancelled.body.html",
        ]
