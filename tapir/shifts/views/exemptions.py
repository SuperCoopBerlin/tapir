...
class ShiftExemptionListView2(LoginRequiredMixin, ListView):
    model = ShiftExemption
...
class ShiftExemptionTable(django_tables2.Table):
    ...
    def render_edit_button(self, value, record: ShiftExemption):
        return format_html(
            "<a href='{}' class='{}'>{}</a>",
            reverse_lazy("shifts:edit_shift_exemption", args=[record.pk]),
