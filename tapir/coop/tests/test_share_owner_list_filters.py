...
class TestShareOwnerList(ShareOwnerFilterTestBase):
    ...
    def test_join_date_filter(self):
        ...
        so1 = ShareOwnership.objects.create(share_owner=share_owner_1, start_date=datetime.date(2023, 1, 1))
        so2 = ShareOwnership.objects.create(share_owner=share_owner_2, start_date=datetime.date(2023, 6, 1))
        so4 = ShareOwnership.objects.create(share_owner=share_owner_4, start_date=datetime.date(2023, 3, 1))
        
        # Create ownerships with 2022 dates
        so3_1 = ShareOwnership.objects.create(share_owner=share_owner_3, start_date=datetime.date(2022, 1, 1))
        so5 = ShareOwnership.objects.create(share_owner=share_owner_5, start_date=datetime.date(2022, 6, 1))
        
        # Second share with start date in 2023 (but owner's first share is in 2022)
        so3_2 = ShareOwnership.objects.create(share_owner=share_owner_3, start_date=datetime.date(2023, 5, 1))
    ...
    def test_user_date_joined_filter(self):
        ...
        user_1 = TapirUserFactory.create(date_joined=timezone.make_aware(datetime.datetime(2023, 1, 1)))
        share_owner_1 = user_1.share_owner
        
        user_2 = TapirUserFactory.create(date_joined=timezone.make_aware(datetime.datetime(2023, 6, 1)))
        share_owner_2 = user_2.share_owner
        
        # Add a third user in 2023 to avoid single-result redirect
        user_extra = TapirUserFactory.create(date_joined=timezone.make_aware(datetime.datetime(2023, 3, 15)))
        share_owner_extra = user_extra.share_owner
        
        user_3 = TapirUserFactory.create(date_joined=timezone.make_aware(datetime.datetime(2022, 1, 1)))
        share_owner_3 = user_3.share_owner
        
        # Add a second user in 2022 to avoid single-result redirect
        user_3b = TapirUserFactory.create(date_joined=timezone.make_aware(datetime.datetime(2022, 6, 1)))
        ...
        self.visit_view(
            {"user_date_joined_start": "2023-01-01", "user_date_joined_end": "2023-12-31"},
        ...
        self.visit_view(
            {"user_date_joined_start": "2022-01-01", "user_date_joined_end": "2022-12-31"},
            must_be_in=[share_owner_3, share_owner_3b],
            must_be_out=[share_owner_1, share_owner_2, share_owner_extra, share_owner_4],
        )
