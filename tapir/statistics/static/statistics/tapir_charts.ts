class ChartManager {
    public register_show_chart_button(button: HTMLElement, url: string, canvas_id: string) {
    ...
    private show_stats_chart(button: HTMLElement, url: string, canvas_id: string) {
